...
- The authenticated service converts unexpected request-dispatch exceptions into the fixed `503` `service unavailable` response, suppresses exception details and second writes after connection aborts, and treats telemetry/event logging as best-effort
