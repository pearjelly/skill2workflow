...
class ServiceDocumentationTests(TestCase):
    def test_service_guide_documents_config_lifecycle_and_security_boundary(self):
        ...
        self.assertIn("Loop 161 adds the cursor-paged backup inventory", guide)
        ...
        self.assertIn("remote-backup-inventory-pages.md", guide)
        ...
        self.assertIn("POST /api/v1/workflow-release-target-reviews", guide)
