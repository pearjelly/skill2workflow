...
class ControlUiContractTests(TestCase):
    def test_operator_ui_surfaces_complete_bounded_and_truncated_scope(self):
        ...
        self.assertIn('id="trigger-workflow-empty"', html)
        self.assertIn("Start Empty Trigger", html)
        self.assertIn("/api/v1/workflow-preflights/", javascript)
        self.assertIn("/api/v1/workflow-empty-triggers", javascript)
        self.assertIn("loadLiveWorkflowPreflight", javascript)
        self.assertIn("triggerLiveWorkflowEmpty", javascript)
        self.assertIn("validateWorkflowEmptyTrigger", javascript)
        self.assertIn("same idempotency key", javascript)
        self.assertIn('id="workflow-input-file"', html)
        self.assertIn('id="preflight-workflow-input"', html)
        self.assertIn('id="trigger-workflow-input"', html)
        self.assertIn("Stage Trigger Input", html)
        self.assertIn("Check Staged Input", html)
        self.assertIn("Start Staged Input", html)
        self.assertIn("/api/v1/workflow-input-preflights", javascript)
        self.assertIn("/api/v1/workflow-input-triggers", javascript)
        self.assertIn("stageWorkflowInputFile", javascript)
        self.assertIn("preflightStagedWorkflowInput", javascript)
        self.assertIn("triggerStagedWorkflowInput", javascript)
        self.assertIn("validateWorkflowInputTrigger", javascript)
        self.assertIn("durable run context", javascript)
        self.assertIn('id="review-triggered-run"', html)
        self.assertIn("Review Started Run", html)
        self.assertIn("reviewTriggeredRun", javascript)
        self.assertIn("liveWorkflowTriggeredRunTarget", javascript)
        self.assertIn("loadLiveRunDetail(receipt.run_id)", javascript)
        self.assertIn("previousTriggeredRun", javascript)
        self.assertIn("bounded redacted run evidence", javascript)
        ...
        self.assertIn('id="preflight-staged-workflow"', html)
        self.assertIn('id="review-staged-workflow-target"', html)
        self.assertIn('id="publish-workflow"', html)
        self.assertIn("Stage Workflow", html)
        self.assertIn("Check Staged Workflow", html)
        self.assertIn("Review Publish Target", html)
        self.assertIn("Publish Staged Workflow", html)
        self.assertIn("/api/v1/workflow-release-preflights", javascript)
        self.assertIn("/api/v1/workflow-release-target-reviews", javascript)
        self.assertIn("/api/v1/workflow-releases", javascript)
        self.assertIn("stageWorkflowReleaseFile", javascript)
        self.assertIn("preflightStagedWorkflow", javascript)
        self.assertIn("reviewStagedWorkflowTarget", javascript)
        self.assertIn("publishStagedWorkflow", javascript)
        self.assertIn("validateWorkflowReleasePreflight", javascript)
        self.assertIn("validateWorkflowReleaseTargetReview", javascript)
        self.assertIn("validateWorkflowRelease", javascript)
        self.assertIn("WORKFLOW_RELEASE_PREFLIGHT_SCHEMA", javascript)
        self.assertIn("WORKFLOW_RELEASE_TARGET_REVIEW_SCHEMA", javascript)
        ...
        self.assertIn("publication still checks atomically", javascript)
        self.assertIn("response.status === 409", javascript)
        self.assertIn("candidate.targetReview = null", javascript)
        self.assertIn("review it again before another publication", javascript)
        self.assertIn("state.liveWorkflowPromotionConflict = true", javascript)
        self.assertIn("state.liveWorkflowDeprecationConflict = true", javascript)
        self.assertIn("Reload Live Workflows before another promotion", javascript)
