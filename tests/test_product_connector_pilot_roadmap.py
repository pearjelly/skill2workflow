...
class ProductConnectorPilotRoadmapTests(TestCase):
    def test_loop_37_product_connector_pilot_is_scoped(self):
        ...
        self.assertIn("Active loop: Loop 38, Live Connector Readiness Review", roadmap)
        ...
        self.assertIn("| Loop 39: Live Connector Implementation Or Deferral | Candidate |", roadmap)
        ...
        self.assertIn("live-readiness review before any live Lark/Feishu API implementation", roadmap)
        self.assertIn("Credential handling and audit redaction rules are explicit", roadmap)
        self.assertIn("Loop 38 readiness review approves a scoped action", roadmap)
