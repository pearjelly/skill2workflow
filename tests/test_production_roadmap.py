...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Completed delivery loops: 1-86", roadmap)
        self.assertIn("- Active loop: None; Loop 86 is complete with protected remote Workflow publication", roadmap)
