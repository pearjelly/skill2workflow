...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Completed delivery loops: 1-185", roadmap)
        self.assertIn("- Active loop: None; Loop 185 is complete with explicit Workflow Bundle side-effect consent", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 185 is complete", roadmap)
