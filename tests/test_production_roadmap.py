...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Active loop: None; Loop 204 is complete with a manifest-declared external connector metadata policy", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 204 is complete", roadmap)
