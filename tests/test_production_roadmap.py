...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Active loop: None; Loop 236 is complete with installed compile-review qualification", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 236 is complete", roadmap)
