...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Active loop: None; Loop 161 is complete with cursor-paged protected remote backup inventory", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 161 is complete", roadmap)
