...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Active loop: None; Loop 218 is complete with live published-workflow inventory", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 218 is complete", roadmap)
