...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Completed delivery loops: 1-77", roadmap)
        self.assertIn("- Active loop: None; Loop 77 is complete with targeted remote run-audit inspection", roadmap)
