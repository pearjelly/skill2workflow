...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Active loop: None; Loop 220 is complete with live empty-trigger preflight", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 220 is complete", roadmap)
