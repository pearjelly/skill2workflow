...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Completed delivery loops: 1-82", roadmap)
        self.assertIn("- Active loop: None; Loop 82 is complete with remote backup readiness diagnostics", roadmap)
    ...
    def test_readme_summarizes_without_copying_the_rolling_queue(self):
        ...
        self.assertIn("Delivery Loops 1-82 are complete", readme)
