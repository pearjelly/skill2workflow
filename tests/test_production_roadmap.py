...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Completed delivery loops: 1-211", roadmap)
        self.assertIn("- Active loop: None; Loop 211 is complete with a confirmation-protected live human-gate action", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 211 is complete", roadmap)
    ...
    def test_readme_summarizes_without_copying_the_rolling_queue(self):
        ...
        self.assertIn("Delivery Loops 1-211 are complete", readme)
