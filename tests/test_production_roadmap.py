...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Completed delivery loops: 1-208", roadmap)
        self.assertIn("- Active loop: None; Loop 208 is complete with an authenticated live control-plane UI and readiness badge", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 208 is complete", roadmap)
    ...
    def test_readme_summarizes_without_copying_the_rolling_queue(self):
        ...
        self.assertIn("Delivery Loops 1-208 are complete", readme)
