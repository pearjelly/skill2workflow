...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Completed delivery loops: 1-139", roadmap)
        self.assertIn("- Active loop: None; Loop 139 is complete with bounded stable-alias resolution", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 139 is complete", roadmap)
    ...
    def test_readme_summarizes_without_copying_the_rolling_queue(self):
        ...
        self.assertIn("Delivery Loops 1-139 are complete", readme)
