...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Active loop: None; Loop 151 is complete with bounded service soak and cutover evidence", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 151 is complete", roadmap)
