...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Active loop: None; Loop 174 is complete with bounded SQLite run-state documents", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 174 is complete", roadmap)
