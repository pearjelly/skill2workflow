...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Completed delivery loops: 1-129", roadmap)
        self.assertIn("- Active loop: None; Loop 129 is complete with bounded due-run batches", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 129 is complete", roadmap)
