...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Active loop: None; Loop 214 is complete with confirmation-protected live cooperative cancellation", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 214 is complete", roadmap)
