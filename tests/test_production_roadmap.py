...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Active loop: None; Loop 133 is complete with streaming backup artifacts", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 133 is complete", roadmap)
