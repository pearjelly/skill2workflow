...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Active loop: None; Loop 230 is complete with live trigger-to-run handoff", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 230 is complete", roadmap)
