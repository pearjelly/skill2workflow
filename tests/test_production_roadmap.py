...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Active loop: None; Loop 168 is complete with bounded local credential-file reads", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 168 is complete", roadmap)
