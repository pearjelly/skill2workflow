...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Completed delivery loops: 1-142", roadmap)
        self.assertIn("- Active loop: None; Loop 142 is complete with bounded interrupted-run takeover", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 142 is complete", roadmap)
