...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Completed delivery loops: 1-210", roadmap)
        self.assertIn("- Active loop: None; Loop 210 is complete with a protected live support-bundle download", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 210 is complete", roadmap)
    ...
    def test_readme_summarizes_without_copying_the_rolling_queue(self):
        ...
        self.assertIn("Delivery Loops 1-210 are complete", readme)
