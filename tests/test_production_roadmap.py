...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Completed delivery loops: 1-181", roadmap)
        self.assertIn("- Active loop: None; Loop 181 is complete with verified local Workflow DSL bundle publication", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 181 is complete", roadmap)
