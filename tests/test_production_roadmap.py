...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Completed delivery loops: 1-187", roadmap)
        self.assertIn("- Active loop: None; Loop 187 is complete with exact Workflow Bundle provenance evidence", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 187 is complete", roadmap)
