...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Completed delivery loops: 1-180", roadmap)
        self.assertIn("- Active loop: None; Loop 180 is complete with portable deterministic Workflow DSL bundles", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 180 is complete", roadmap)
