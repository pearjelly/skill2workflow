...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Completed delivery loops: 1-188", roadmap)
        self.assertIn("- Active loop: None; Loop 188 is complete with structured Workflow Bundle admission refusals", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 188 is complete", roadmap)
