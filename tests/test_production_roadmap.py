...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Completed delivery loops: 1-78", roadmap)
        self.assertIn("- Active loop: None; Loop 78 is complete with remote recurring-schedule inventory", roadmap)
