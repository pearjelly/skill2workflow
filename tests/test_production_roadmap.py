...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Active loop: None; Loop 206 is complete with an installed static UI launcher", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 206 is complete", roadmap)
