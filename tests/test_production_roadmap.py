...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Active loop: None; Loop 189 is complete with safe Workflow Bundle run summaries", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 189 is complete", roadmap)
