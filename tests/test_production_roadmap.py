...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Active loop: None; Loop 216 is complete with bounded live recurring-schedule discovery", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 216 is complete", roadmap)
        ...
        self.assertIn(
            "**Status:** Directional; Loops 44-216 complete, further loop numbers unassigned.",
            roadmap,
        )
