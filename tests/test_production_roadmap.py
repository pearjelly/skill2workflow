...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Active loop: None; Loop 252 is complete with custom controlled quickstart input", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 252 is complete", roadmap)
