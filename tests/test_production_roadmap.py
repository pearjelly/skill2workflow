...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Completed delivery loops: 1-213", roadmap)
        self.assertIn("- Active loop: None; Loop 213 is complete with bounded live run discovery", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 213 is complete", roadmap)
        ...
        self.assertIn(
            "**Status:** Directional; Loops 44-213 complete, further loop numbers unassigned.",
            roadmap,
        )
    ...
    def test_readme_summarizes_without_copying_the_rolling_queue(self):
        ...
        self.assertIn("Delivery Loops 1-213 are complete", readme)
