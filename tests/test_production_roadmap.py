...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Active loop: None; Loop 146 is complete with compact SQLite recurring-schedule summaries", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 146 is complete", roadmap)
