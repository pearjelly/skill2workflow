...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Completed delivery loops: 1-182", roadmap)
        self.assertIn("- Active loop: None; Loop 182 is complete with value-free Workflow DSL bundle diff review", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 182 is complete", roadmap)
