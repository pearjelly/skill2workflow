...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Active loop: None; Loop 147 is complete with compact SQLite run-detail projections", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 147 is complete", roadmap)
