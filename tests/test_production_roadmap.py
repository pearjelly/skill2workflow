...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Completed delivery loops: 1-89", roadmap)
        self.assertIn("- Active loop: None; Loop 89 is complete with protected local ingress-token rotation", roadmap)
