...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Active loop: None; Loop 222 is complete with live recurring dispatch evidence", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 222 is complete", roadmap)
