...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Active loop: None; Loop 179 is complete with side-effect-free trigger preflight", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 179 is complete", roadmap)
