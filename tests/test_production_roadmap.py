...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Completed delivery loops: 1-109", roadmap)
        self.assertIn("- Active loop: None; Loop 109 is complete with live HTTP and scheduler pressure metrics", roadmap)
    ...
    def test_readme_summarizes_without_copying_the_rolling_queue(self):
        ...
        self.assertIn("Delivery Loops 1-109 are complete", readme)
