...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Active loop: None; Loop 231 is complete with local SKILL.md editor compilation", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 231 is complete", roadmap)
