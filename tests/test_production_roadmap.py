...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Active loop: None; Loop 254 is complete with verified remote authoring publication", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 254 is complete", roadmap)
