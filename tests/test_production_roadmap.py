...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Active loop: None; Loop 152 is complete with a Production Baseline evidence bundle", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 152 is complete", roadmap)
