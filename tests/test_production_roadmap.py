...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Completed delivery loops: 1-145", roadmap)
        self.assertIn("- Active loop: None; Loop 145 is complete with compact SQLite run summaries", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 145 is complete", roadmap)
