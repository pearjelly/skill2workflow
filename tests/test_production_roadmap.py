...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Active loop: None; Loop 178 is complete with bounded, side-effect-free workflow explanations", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 178 is complete", roadmap)
