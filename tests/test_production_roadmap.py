...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Completed delivery loops: 1-173", roadmap)
        self.assertIn("- Active loop: None; Loop 173 is complete with bounded external connector result envelopes", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 173 is complete", roadmap)
    ...
    def test_readme_summarizes_without_copying_the_rolling_queue(self):
        ...
        self.assertIn("Delivery Loops 1-173 are complete", readme)
