...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Completed delivery loops: 1-97", roadmap)
        self.assertIn("- Active loop: None; Loop 97 is complete with a fail-closed service exception boundary", roadmap)
