...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Active loop: None; Loop 205 is complete with a protected uncertain-dispatch review action", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 205 is complete", roadmap)
