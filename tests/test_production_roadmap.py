...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Active loop: None; Loop 120 is complete with atomic SQLite state initialization", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 120 is complete", roadmap)
