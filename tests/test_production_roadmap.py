...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Completed delivery loops: 1-153", roadmap)
        self.assertIn("- Active loop: None; Loop 153 is complete with a bounded remote audit event tail", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 153 is complete", roadmap)
