...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Completed delivery loops: 1-80", roadmap)
        self.assertIn("- Active loop: None; Loop 80 is complete with protected remote recurring-schedule dispatch diagnostics", roadmap)
    ...
    def test_readme_summarizes_without_copying_the_rolling_queue(self):
        ...
        self.assertIn("Delivery Loops 1-80 are complete", readme)
