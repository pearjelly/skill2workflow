...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Active loop: None; Loop 257 is complete with publication conflict recovery", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 257 is complete", roadmap)
