...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Active loop: None; Loop 134 is complete with streaming stale-claim recovery", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 134 is complete", roadmap)
