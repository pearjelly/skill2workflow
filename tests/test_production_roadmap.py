...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Completed delivery loops: 1-186", roadmap)
        self.assertIn("- Active loop: None; Loop 186 is complete with compact Workflow Bundle run evidence", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 186 is complete", roadmap)
