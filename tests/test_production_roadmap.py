...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Completed delivery loops: 1-207", roadmap)
        self.assertIn("- Active loop: None; Loop 207 is complete with an authenticated live control-plane UI", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 207 is complete", roadmap)
        ...
        self.assertIn(
            "**Status:** Directional; Loops 44-207 complete, further loop numbers unassigned.",
            roadmap,
        )
        ...
        self.assertIn(
            "| Loop 190: Bounded External Connector Fixture Loading | Complete |",
            roadmap,
        )
        ...
        self.assertIn(
            "| Loop 197: Declarative HTTP Origin Governance | Complete |",
            roadmap,
        )
        self.assertIn("### Loop 197: Declarative HTTP Origin Governance", roadmap)
        self.assertIn(
            "| Loop 198: Fixed HTTP Transport Error Redaction | Complete |",
            roadmap,
        )
        ...
        self.assertIn(
            "| Loop 200: Service-Level HTTP Origin Upper Bound | Complete |",
            roadmap,
        )
        ...
        self.assertIn(
            "| Loop 202: Durable External Connector Failure Boundary | Complete |",
            roadmap,
        )
        self.assertIn("### Loop 202: Durable External Connector Failure Boundary", roadmap)
    ...
    def test_readme_summarizes_without_copying_the_rolling_queue(self):
        ...
        self.assertIn("Delivery Loops 1-207 are complete", readme)
