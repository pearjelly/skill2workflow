...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Active loop: None; Loop 223 is complete with live uncertain-dispatch review", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 223 is complete", roadmap)
