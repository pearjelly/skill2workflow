...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Completed delivery loops: 1-128", roadmap)
        self.assertIn("- Active loop: None; Loop 128 is complete with bounded artifact diagnostics", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 128 is complete", roadmap)
