...
class ProductionRoadmapTests(TestCase):
    def test_roadmap_uses_a_rolling_production_readiness_path(self):
        ...
        self.assertIn("- Completed delivery loops: 1-238", roadmap)
        self.assertIn("- Active loop: None; Loop 238 is complete with source-free node validation locations", roadmap)
        ...
        self.assertIn("This rolling queue is ordered. Loop 238 is complete", roadmap)
    ...
    def test_readme_summarizes_without_copying_the_rolling_queue(self):
        ...
        self.assertIn("Delivery Loops 1-238 are complete", readme)
