...
class LiveControlSnapshotDocumentationTests(TestCase):
    ...
    def test_public_contracts_record_loop_55_and_fixed_route(self):
        ...
        self.assertIn("workflow-diffs/{workflow_id}/{from_version}/{to_version}", guide)
        self.assertIn("skill2workflow-workflow-diff-0.1.0", guide)
        self.assertIn("Compare Versions", installed_ui)
        ...
        self.assertIn("workflow-promotions", guide)
        self.assertIn("Promote to production", installed_ui)
