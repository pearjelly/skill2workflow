...
class RuntimeTelemetryTests(TestCase):
    ...
    def test_metrics_are_aggregate_low_cardinality_and_private_value_free(self):
        with TemporaryDirectory() as tmp:
            ...
            telemetry.observe_http("recurring_schedule_dispatch_review", 200)
            ...
            telemetry.observe_http("workflow_release_target_review", 200)
        ...
        for line in (
            ...
            'skill2workflow_http_requests_total{route="recurring_schedule_dispatch_review",status_class="2xx"} 1',
            ...
            'skill2workflow_http_requests_total{route="workflow_release_target_review",status_class="2xx"} 1',
    ...
    def test_aggregate_support_bundle_contract_is_fixed_and_value_free(self):
        ...
        self.assertEqual(
            set(aggregate["http_requests"]),
            {
                ...
                "recurring_schedule_create", "recurring_schedule_action", "recurring_schedule_update", "recurring_schedule_patch", "recurring_schedule_delete", "recurring_schedule_dispatch_list", "recurring_schedule_dispatch_page", "recurring_schedule_dispatch_review",
                ...
                "audit_event_list",
                "workflow_release", "workflow_release_target_review", "workflow_promotion", "workflow_deprecation", "workflow_inventory", "workflow_diff", "workflow_explanation", "workflow_preflight", "run_resume", "unknown",
            },
        )
