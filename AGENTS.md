...
- Installed UI preview: `skill2workflow ui --port 4173`, then open `http://127.0.0.1:4173/web/`; add `--service-url` and `--auth-token-file` only for the fixed read-only live snapshot proxy
