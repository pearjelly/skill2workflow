...
source-free issue codes; a valid draft can then be downloaded as Workflow DSL.
...
Current maturity: Self-hosted Beta. The local-first harness covers all five approved architecture layers, and Delivery Loops 1-237 are complete.
